...
namespace AssetFlow.Data.Migrations
{
    ...
    [Migration("20260920225538_TenantAddedInLocation")]
    partial class TenantAddedInLocation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AssetFlow.Data.Entities.ACL.Resource", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = 38,
                            FeatureId = 46,
                            ResourceName = "LocationType.View"
                        },
                        new
                        {
                            Id = 39,
                            FeatureId = 46,
                            ResourceName = "LocationType.Create"
                        },
                        new
                        {
                            Id = 40,
                            FeatureId = 46,
                            ResourceName = "LocationType.Update"
                        },
                        new
                        {
                            Id = 41,
                            FeatureId = 46,
                            ResourceName = "LocationType.Delete"
                        },
                        new
                        {
                            Id = 42,
                            FeatureId = 47,
                            ResourceName = "Location.View"
                        },
                        new
                        {
                            Id = 43,
                            FeatureId = 47,
                            ResourceName = "Location.Create"
                        },
                        new
                        {
                            Id = 44,
                            FeatureId = 47,
                            ResourceName = "Location.Update"
                        },
                        new
                        {
                            Id = 45,
                            FeatureId = 47,
                            ResourceName = "Location.Delete"
                        });
                });
            ...
            modelBuilder.Entity("AssetFlow.Data.Entities.Location.Location", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AssetFlow.Data.Entities.Location.LocationType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("ParentLocationTypeId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ParentLocationTypeId");
            ...
            modelBuilder.Entity("AssetFlow.Data.Entities.Location.Location", b =>
                {
                    ...
                    b.HasOne("AssetFlow.Data.Entities.Location.LocationType", "LocationType")
                        .WithMany("Locations")
                    ...
                    b.HasOne("AssetFlow.Data.Entities.Location.Location", "ParentLocation")
            ...
            modelBuilder.Entity("AssetFlow.Data.Entities.Location.LocationType", b =>
                {
                    ...
                    b.HasOne("AssetFlow.Data.Entities.Location.LocationType", "ParentLocationType")
                        .WithMany("ChildLocationTypes")
                        .HasForeignKey("ParentLocationTypeId")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.Navigation("ParentLocationType");
            ...
            modelBuilder.Entity("AssetFlow.Data.Entities.Location.LocationType", b =>
                {
                    b.Navigation("ChildLocationTypes");
